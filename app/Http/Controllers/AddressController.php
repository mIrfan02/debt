...
class AddressController extends Controller
{
    ...
    private $_directory = 'auth/pages/addresses';
    private $_route = 'addresses';
    ...
    public function store(AddressRequest $request)
    {
        try {
            ...
            return redirect()->route($this->_route . '.index')->with('success', 'Address created successfully!');
        } catch (\Throwable $th) {
            //throw $th;
    ...
    public function update(AddressRequest $request, $id)
    {
        try {
            ...
            return redirect()->route($this->_route . '.index')->with('success', 'SAddress updated successfully!');
        } catch (\Throwable $th) {
            //throw $th;
            return redirect()->route($this->_route . '.index')->with('error', 'Something went wrong.');
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route($this->_route . '.index')->with('success', 'SAddress deleted successfully!');
    }
}

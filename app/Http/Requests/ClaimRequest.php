    ...
    public function rules(): array
    {
        ...
        if ($httpMethod == 'POST') {
            $rules = [
                ...
                'debtor_organization' => 'nullable|string|max:255',
                'placement_amount' => 'required|numeric',
                'interest_start_date' => 'required|date',
                'pre_judgment_interest' => 'nullable|numeric',
                'post_judgment_interest' => 'nullable|numeric',
                ...
                'type_of_debt' => 'nullable|string|max:255',

<x-auth-layout pageTitle="All Agreements">
            ...
            <tbody>
                @foreach ($data['all'] as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('agreements.show', $item->id) }}" title="View agreement details"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('agreements.destroy', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
